...
def objective(params):
    ...
    outpath = "../../checkpoints/hyperopt_1692019_inception/"+str(params['pretrained'])+"opt_"+params['optimizer']+"batch_"+str(params['batch_size'])+"bottleneck_"+str(params['num_features'])
    config = {
